                    ...
                    <div style={{ display: 'flex', flexDirection: 'row', alignItems: 'flex-start', justifyContent: 'flex-start', marginTop: '60px' }}>
                        ...
                        <div style={{ marginLeft: '60px', marginTop: '60px' }}>
                            ...
                            <div style={{ marginTop: '20px' }}>
                                <span onClick={() => increaseCount()} style={{ fontSize: '40px', fontWeight: 'bold', cursor: 'pointer', marginRight: '10px' }}> + </span>
                                <span style={{ fontSize: '30px', fontFamily: 'arial' }}>{count}</span>
                                <span onClick={() => decreaseCount()} style={{ fontSize: '40px', fontWeight: 'bold', cursor: 'pointer', marginLeft: '10px' }}> - </span>
                            </div>
